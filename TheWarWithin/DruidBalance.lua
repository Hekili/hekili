...
spec:RegisterTalents( {
    ...
    rake                        = {  82199,   1822, 1 }, -- Rake the target for 6,277 Bleed damage and an additional 37,493 Bleed damage over 15 sec. While stealthed, Rake will also stun the target for 4 sec and deal 60% increased damage. Awards 1 combo point.
    ...
    rejuvenation                = {  82217,    774, 1 }, -- Heals the target for 44,006 over 12 sec.
    ...
    rip                         = {  82222,   1079, 1 }, -- Finishing move that causes Bleed damage over time. Lasts longer per combo point. 1 point : 29,587 over 8 sec 2 points: 44,380 over 12 sec 3 points: 59,174 over 16 sec 4 points: 73,967 over 20 sec 5 points: 88,761 over 24 sec
    ...
    starfire                    = {  82201, 194153, 1 }, -- Call down a burst of energy, causing 22,757 Arcane damage to the target, and 7,322 Arcane damage to all other enemies within 10 yards. Deals reduced damage beyond 8 targets. Generates 10 Astral Power.
    starlight_conduit           = { 100223, 451211, 1 }, -- Wrath, Starsurge, and Starfire damage increased by 5%. 
    starsurge                   = {  82202,  78674, 1 }, -- Launch a surge of stellar energies at the target, dealing 69,759 Astral damage.
    ...
    sunfire                     = {  82208,  93402, 1 }, -- A quick beam of solar light burns the enemy for 4,975 Nature damage and then an additional 61,248 Nature damage over 18 sec to the primary target and all enemies within 8 yards. Generates 6 Astral Power.
    ...
    wild_growth                 = {  82205,  48438, 1 }, -- Heals up to 5 injured allies within 30 yards of the target for 37,764 over 7 sec. Healing starts high and declines over the duration.
    ...
    convoke_the_spirits         = {  88206, 391528, 1 }, -- Call upon the spirits for an eruption of energy, channeling a rapid flurry of 16 Druid spells and abilities over 4 sec. You will cast Wild Growth, Swiftmend, Moonfire, Wrath, Regrowth, Rejuvenation, Rake, and Thrash on appropriate nearby targets, favoring your current shapeshift form.
    cosmic_rapidity             = {  88227, 400059, 2 }, -- Your Moonfire, Sunfire, and Stellar Flare deal damage 20% more frequently.
    crashing_star               = { 103847, 468978, 1 }, -- Shooting Stars has a 15% chance to instead call down a Crashing Star, dealing 26,761 Astral damage to the target and generating 4 Astral Power.
    ...
    fury_of_elune               = {  88224, 202770, 1 }, -- Calls down a beam of pure celestial energy that follows the enemy, dealing up to 72,174 Astral damage over 8 sec within its area. Damage reduced on secondary targets. Generates 40 Astral Power over its duration.
    ...
    new_moon                    = {  88224, 274281, 1 }, -- Deals 63,573 Astral damage to the target and empowers New Moon to become Half Moon. Generates 10 Astral Power.
    orbit_breaker               = {  88199, 383197, 1 }, -- Every 30th Shooting Star calls down a Full Moon at 60% effectiveness upon its target.
    orbital_strike              = {  88221, 390378, 1 }, -- Incarnation: Chosen of Elune blasts all enemies in a targeted area for 49,549 Astral damage and applies Stellar Flare to them. Reduces the cooldown of Incarnation: Chosen of Elune by 60 sec.
    power_of_goldrinn           = {  88200, 394046, 1 }, -- Starsurge has a chance to summon the Spirit of Goldrinn, which immediately deals 14,490 Astral damage to the target.
    ...
    shooting_stars              = {  88225, 202342, 1 }, -- Moonfire and Sunfire damage over time has a chance to call down a falling star, dealing 8,918 Astral damage and generating 2 Astral Power.
    ...
    stellar_flare               = {  91048, 202347, 1 }, -- Burns the target for 4,417 Astral damage, and then an additional 58,790 damage over 24 sec. If dispelled, causes 52,027 damage to the dispeller and blasts them upwards. Generates 12 Astral Power.
    ...
    sunseeker_mushroom          = {  88202, 468936, 1 }, -- Sunfire damage has a chance to grow a magical mushroom at a target's location. After 1 sec, the mushroom detonates, dealing 56,321 Nature damage and then an additional 31,769 Nature damage over 10 sec. Affected targets are slowed by 50%. Generates up to 20 Astral Power based on targets hit. 
    ...
    wild_mushroom               = {  88202,  88747, 1 }, -- Grow a magical mushroom at the target enemy's location. After 1 sec, the mushroom detonates, dealing 56,321 Nature damage and then an additional 31,769 Nature damage over 10 sec. Affected targets are slowed by 50%. Generates up to 20 Astral Power based on targets hit.
    ...
    the_light_of_elune          = {  94585, 428655, 1 }, -- Moonfire damage has a chance to call down a Fury of Elune to follow your target for 3 sec.  Fury of Elune Calls down a beam of pure celestial energy, dealing 27,065 Astral damage over 3 sec within its area. Generates 15 Astral Power over its duration.
...
spec:RegisterPvpTalents( { 
    ...
    thorns                 = 3731, -- (1217017) Casting Barkskin sprouts thorns on you for until canceled. When victim to melee attacks, thorns deals 25,165 Nature damage back to the attacker. Attackers also have their movement speed reduced by 50% for 4 sec.
