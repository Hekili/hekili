...
spec:RegisterTalents( {
    ...
    panacea                         = { 93348, 387761, 1 }, -- Emerald Blossom and Verdant Embrace instantly heal you for 64,245 when cast.
    ...
    unravel                         = { 93308, 368432, 1 }, -- Sunder an enemy's protective magic, dealing 309,604 Spellfrost damage to absorb shields.
    verdant_embrace                 = { 93341, 360995, 1 }, -- Fly to an ally and heal them for 214,837, or heal yourself for the same amount.
    ...
    dream_breath                    = { 93240, 355936, 1 }, -- Inhale, gathering the power of the Dream. Release to exhale, healing 5 injured allies in a 30 yd cone in front of you for 219,506. I: Heals 39,472 instantly and 180,034 over 16 sec. II: Heals 84,480 instantly and 135,025 over 12 sec. III: Heals 129,489 instantly and 90,017 over 8 sec.
    dream_flight                    = { 93267, 359816, 1 }, -- Take in a deep breath and fly to the targeted location, healing all allies in your path for 123,351 immediately, and 87,907 over 15 sec. Healing increased by 100% when not in a raid. Removes all root effects. You are immune to movement impairing and loss of control effects while flying.
    dreamwalker                     = { 93244, 377082, 1 }, -- You are able to move while communing with the Dream.
    echo                            = { 93339, 364343, 1 }, -- Wrap an ally with temporal energy, healing them for 61,675 and causing your next non-Echo healing spell to cast an additional time on that ally at 70% of normal healing.
    emerald_communion               = { 93245, 370960, 1 }, -- Commune with the Emerald Dream, restoring 20% health and 2% mana every 0.9 sec for 4.4 sec. Overhealing is transferred to an injured ally within 40 yds. Castable while stunned, disoriented, incapacitated, or silenced.
    empath                          = { 93242, 376138, 1 }, -- Spiritbloom increases your Essence regeneration rate by 100% for 8 sec.
    energy_loop                     = { 93261, 372233, 1 }, -- Disintegrate deals 35% more damage and generates 126,000 mana over its duration.
    ...
    essence_burst                   = { 93239, 369297, 1 }, -- Living Flame has a 20% chance, and Reversion has a 15% chance to make your next Essence ability free.
    ...
    fluttering_seedlings            = { 93247, 359793, 2 }, -- Emerald Blossom sends out flying seedlings when it bursts, healing 2 allies up to 40 yds away for 39,935.
    ...
    reversion                       = { 93338, 366155, 1 }, -- Reverse an ally's injuries, healing them for 120,257 over 12 sec. When Reversion critically heals, its duration is extended by 2 sec, up to a maximum of 12 sec.
    rewind                          = { 93337, 363534, 1 }, -- Rewind 33% of damage taken in the last 5 seconds by all allies within 40 yds. Always heals for at least 94,030. Healing increased by 100% when not in a raid.
    ...
    spiritbloom                     = { 93243, 367226, 1 }, -- Divert spiritual energy, healing an ally for 261,351. Splits to injured allies within 30 yds when empowered. I: Heals one ally. II: Heals a second ally. III: Heals a third ally.
    ...
    temporal_anomaly                = { 93257, 373861, 1 }, -- Send forward a vortex of temporal energy, absorbing 68,528 damage on you and any allies in its path. Absorption is reduced beyond 5 targets.
    ...
    time_of_need                    = { 93259, 368412, 1 }, -- When you or an ally fall below 30% health, a version of yourself enters your timeline and heals them for 214,837. Your alternate self continues healing for 8 sec before returning to their timeline. May only occur once every 60 sec.
    ...
    chrono_flame                    = { 94954, 431442, 1 }, -- Living Flame is enhanced with Bronze magic, repeating 15% of the damage or healing you dealt to the target in the last 5 sec as Arcane, up to 122,373.
    ...
    -- Scalecommander
    bombardments                    = { 94936, 434300, 1 }, -- Mass Eruption marks your primary target for destruction for the next 10 sec. You and your allies have a chance to trigger a Bombardment when attacking marked targets, dealing 63,634 Volcanic damage split amongst all nearby enemies.
    ...
    engulf                          = { 94950, 443328, 1 }, -- Engulf your target in dragonflame, damaging them for 229,106 Fire or healing them for 218,434. For each of your periodic effects on the target, effectiveness is increased by 50%.
    ...
    maneuverability                 = { 94941, 433871, 1 }, -- Deep Breath can now be steered in your desired direction. In addition, Deep Breath burns targets for 338,905 Volcanic damage over 12 sec.
...
spec:RegisterPvpTalents( { 
    ...
    divide_and_conquer   = 5595, -- (384689) Deep Breath forms curtains of fire, preventing line of sight to enemies outside its walls and burning enemies who walk through them for 352,434 Fire damage. Lasts 6 sec.
    dream_catcher        = 5598, -- (410962) Sleep Walk no longer has a cooldown, but its cast time is increased by 0.2 sec.
    dream_projection     = 5454, -- (377509) Summon a flying projection of yourself that heals allies you pass through for 102,793. Detonating your projection dispels all nearby allies of Magical effects, and heals for 508,825 over 20 sec.
    dreamwalkers_embrace = 5616, -- (415651) Verdant Embrace tethers you to an ally, increasing movement speed by 40% and slowing and siphoning 61,186 life from enemies who come in contact with the tether. The tether lasts up to 10 sec or until you move more than 30 yards away from your ally.
