...
spec:RegisterTalents( {
    ...
    flowing_spirits           = {  80971, 469314, 1 }, -- Your damaging abilities have a chance to summon a Feral Spirit for $469329d.
    ...
    ice_strike                = {  80956, 470194, 1 }, -- Strike your target with an icy blade, dealing $s1 Frost damage and snaring them by $s2% for $d.; Ice Strike increases the damage of your next Frost Shock by $384357s1%$?s384359[ and generates $384359s1 $Lstack:stacks; of Maelstrom Weapon][].
    ...
    molten_thunder            = { 103848, 469344, 1 }, -- The cooldown of Sundering is reduced by ${$s1/-1000} sec but it can no longer Incapacitate. ; Stormsurge has a small chance to also reset the cooldown of Sundering.
    ...
    stormblast                = {  80960, 319930, 1 }, -- Stormstrike has an additional charge.; Stormsurge now also causes your next Stormstrike to deal $s1% additional damage as Nature damage, stacking up to $470466u times.
    ...
    voltaic_blaze             = { 103871, 470053, 1 }, -- [470057] Instantly shocks the target and ${$i-1} nearby enemies with blazing thunder, causing $s1 Nature damage and applying Flame Shock.; Generates $s2 $Lstack:stacks; of Maelstrom Weapon.
    ...
    lively_totems             = { 94882, 445034, 1 }, -- $?a137041[Lava Lash has a chance to summon a Searing Totem to hurl Searing Bolts that deal $3606s1 Fire damage to a nearby enemy. Lasts $458101d.; Frost Shocks empowered by Hailstorm, Lava Lash, and Fire Nova cause your Searing totems to shoot a Searing Volley at up to $s3 nearby enemies for $458147s1 Fire damage.][When you summon a Healing Tide Totem, Healing Stream Totem, Cloudburst Totem, Mana Tide Totem, or Spirit Link Totem you cast a free instant Chain Heal at $458221s2% effectiveness.]
