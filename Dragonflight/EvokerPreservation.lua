...
spec:RegisterTalents( {
    ...
    dream_flight         = { 93267, 359816, 1 }, -- Take in a deep breath and fly to the targeted location, healing all allies in your path for $363502s2 immediately, and $363502o1 over $363502d.; Removes all root effects. You are immune to movement impairing and loss of control effects while flying.
    ...
    essence_burst        = { 93239, 369297, 1 }, -- Living Flame has a $s1% chance to make your next Essence ability free.$?s375722[ Stacks $359618u times.][]
    ...
    fluttering_seedlings = { 93247, 359793, 2 }, -- Emerald Blossom sends out $s1 flying $Lseedling:seedlings; when it bursts, healing allies up to $s2 yds away for $361361s1.
    ...
    grace_period         = { 93265, 376239, 2 }, -- Your healing is increased by $s1% on targets with your Reversion.
    ...
    lifegivers_flame     = { 93237, 371426, 2 }, -- Fire Breath heals $s3 nearby injured allies for $s1% of damage done to up to $s2 targets, split evenly among them.
    ...
    reversion            = { 93338, 366155, 1 }, -- Repair an ally's injuries, healing them for $o1 over $d. When Reversion critically heals, its duration is extended by $t1 sec.
    ...
    timeless_magic       = { 93263, 376240, 2 }, -- Reversion, Time Dilation, and Echo last $s1% longer.
} )
