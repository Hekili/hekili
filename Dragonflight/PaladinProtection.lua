...
spec:RegisterSetting( "goak_damage", 40, {
    ...
    desc = function() return strformat( L["When set above zero, the addon may recommend %s when you take this percentage of your maximum health in damage in the past 5 seconds."],
        "|T135919:0|t " .. GetSpellInfo( class.abilities.guardian_of_ancient_kings.id ) or L["Guardian of Ancient Kings"] ) .. "\n\n"
        .. L["By default, your Defensives toggle must also be enabled."]
    end,
    type = "range",
    min = 0,
    max = 100,
...
spec:RegisterSetting( "ds_damage", 60, {
    ...
    desc = function() return strformat( L["When set above zero, the addon may recommend %s when you take this percentage of your maximum health in damage in the past 5 seconds."],
        "|T524354:0|t " .. GetSpellInfo( class.abilities.divine_shield.id ) or L["Divine Shield"] ) .. "\n\n"
        .. L["By default, your Defensives toggle must also be enabled."]
    end,
    type = "range",
    min = 0,
