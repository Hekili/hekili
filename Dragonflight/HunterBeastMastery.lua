...
spec:RegisterSetting( "check_pet_range", false, {
    ...
    desc = function ()
        return L["If checked, the addon will not recommend |T132176:0|t Kill Command if your pet is not in range of your target."] .. "\n\n"
        .. ( state.settings.petbased and "|cFF00FF00" or "|cFFFF0000" ) .. L["Requires Pet-Based Target Detection"] .. "|r"
    end,
    type = "toggle",
    width = "full"
} )
