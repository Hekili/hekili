...
spec:RegisterSetting( "manage_ds_ticks", false, {
    ...
    desc = L["If checked, the addon will expend |cFFFF0000more CPU|r determining when to break |T136163:0|t Drain Soul channels in favor of other spells."] .. "  "
        .. L["This is generally not worth it, but is technically more accurate."],
    type = "toggle",
    width = "full"
} )
