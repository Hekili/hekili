...
spec:RegisterTalents( {
    ...
    dark_ascension             = { 82657, 391109, 1 }, -- Increases your non-periodic Shadow damage by $s1% for 20 sec.; Generates ${$m2/100} Insanity.
    ...
    deathspeaker               = { 82558, 392507, 1 }, -- Your Shadow Word: Pain damage has a chance to reset the cooldown of Shadow Word: Death, increase its damage by $392511s2%, and always deal $32379s3% increased damage regardless of the target's health.
    ...
    halo                       = { 82680, 120644, 1 }, -- Creates a ring of Shadow energy around you that quickly expands to a 30 yd radius, healing allies for $120692s1 and dealing $<shadowhalodamage> Shadow damage to enemies. Healing reduced beyond $s1 targets.$?s137033[; Generates ${$m2/100} Insanity.][]
    ...
    inescapable_torment        = { 82644, 373427, 1 }, -- Mind Blast and Shadow Word: Death cause your Mindbender to teleport behind your target, slashing up to $s1 nearby enemies for $<value> Shadow damage and increasing the duration of Mindbender by ${$s2/1000}.1 sec.
    ...
    intangibility              = { 82659, 288733, 1 }, -- Dispersion heals you for an additional $s2% of your maximum health over its duration and its cooldown is reduced by ${$s1/-1000} sec.
    ...
    shadow_crash               = { 82669, 205385, 1 }, -- Hurl a bolt of slow-moving Shadow energy at the destination, dealing $205386s1 Shadow damage.; Generates $/100;s2 Insanity.
