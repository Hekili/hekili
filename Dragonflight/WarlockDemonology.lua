...
-- Value update function.
    function( current, default )
        if ( variable.tyrant_sync or 0 ) <= 0 and ( ( buff.nether_portal.up and buff.nether_portal.remains < 3 and talent.nether_portal.enabled ) or
        boss and fight_remains < 20 or
        pet.demonic_tyrant.active and fight_remains < 100 or
        boss and fight_remains<25 or
        ( pet.demonic_tyrant.active or not talent.summon_demonic_tyrant.enabled and buff.dreadstalkers.up ) ) then
            return time + ( 120 - time % 120 )
        end

        if cooldown.summon_demonic_tyrant.remains < 15 and cooldown.summon_vilefiend.remains < gcd.max * 5 and cooldown.call_dreadstalkers.remains < gcd.max * 5 and
        ( cooldown.grimoire_felguard.remains < 10 or set_bonus.tier30_2pc == 0 ) and ( ( variable.tyrant_cd or 0 ) < 15 or fight_remains < 40 or buff.power_infusion.up ) and
        not ( raid_event.adds['in'] < 15 - raid_event.add.duration ) or talent.summon_vilefiend.enabled and cooldown.summon_demonic_tyrant.remains < 15 and
        cooldown.summon_vilefiend.remains < gcd.max * 5 and cooldown.call_dreadstalkers.remains < gcd.max * 5 and
        ( cooldown.grimoire_felguard.remains < 10 or set_bonus.tier30_2pc == 0 ) and ( variable.tyrant_cd < 15 or fight_remains < 40 or buff.power_infusion.up ) or
        cooldown.summon_demonic_tyrant.remains < 15 and ( buff.vilefiend.up or not talent.summon_vilefiend.enabled and
        ( buff.grimoire_felguard.up or cooldown.grimoire_felguard.up or set_bonus.tier30_2pc == 0 ) ) and
        ( ( variable.tyrant_cd or 0 ) < 15 or buff.grimoire_felguard.up or fight_remains < 40 or buff.power_infusion.up ) then
            -- actions.tyrant+=/variable,name=tyrant_timings,op=set,value=120+time,if=variable.pet_expire>0&variable.pet_expire<action.summon_demonic_tyrant.execute_time+(buff.demonic_core.down*action.shadow_bolt.execute_time+buff.demonic_core.up*gcd.max)+gcd.max&variable.tyrant_timings<=0
            if variable.pet_expire > 0 and
            variable.pet_expire < action.summon_demonic_tyrant.execute_time +
            ( buff.demonic_core.down and ( action.shadow_bolt.execute_time + ( buff.demonic_core.up and gcd.max or 0 ) ) or 0 ) +
            gcd.max and variable.tyrant_timings <= 0 then
                return 120 + time
            end
        end
...
spec:RegisterPhasedVariable( "tyrant_sync",
    function() return ( variable.tyrant_timings or 0 ) - time end,
    function( current, default )
        return default
    end,
"reset_precast", "advance_end", "runHandler" )

-- actions+=/variable,name=tyrant_cd,op=setif,value=variable.tyrant_sync,value_else=cooldown.summon_demonic_tyrant.remains,condition=((((fight_remains+time)%%120<=85&(fight_remains+time)%%120>=25)|time>=210))&variable.tyrant_sync>0&!talent.grand_warlocks_design
spec:RegisterPhasedVariable( "tyrant_cd",
    function()
        return cooldown.summon_demonic_tyrant.remains_expected
    end,
    function( current, default )
        if ( fight_remains + time ) / 120 <= 85 and fight_remains + time / 120 >= 25 and variable.tyrant_sync > 0 and not talent.grand_warlocks_design.enabled then
            return variable.tyrant_sync
