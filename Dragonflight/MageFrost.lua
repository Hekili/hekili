...
spec:RegisterTalents( {
    ...
    chain_reaction           = { 62163, 278309, 1 }, -- Your Ice Lances against frozen targets increase the damage of your Ice Lances by $s1% for $278310d, stacking up to $278310u times.
    cold_front               = { 62185, 382110, 1 }, -- Casting $s1 Frostbolts or Flurries calls down a Frozen Orb toward your target. Hitting an enemy player counts as double.
    coldest_snap             = { 62155, 417493, 1 }, -- Cone of Cold's cooldown is increased to $s2 sec and if Cone of Cold hits $s3 or more enemies it resets the cooldown of Frozen Orb and Comet Storm. In addition, Cone of Cold applies Winter's Chill to all enemies hit.; Cone of Cold's cooldown can no longer be reduced by your cooldown reduction effects.
    ...
    fractured_frost          = { 62184, 378448, 2 }, -- Your Frostbolt has a $s2% chance to hit up to ${$s3-1} additional targets.
    ...
    freezing_winds           = { 62151, 382103, 1 }, -- While Frozen Orb is active, you gain Fingers of Frost every $382106t1 sec.
    ...
    hailstones               = { 62158, 381244, 2 }, -- Casting Ice Lance on Frozen targets has a $s1% chance to generate an Icicle.
    ...
    ice_caller               = { 62169, 236662, 1 }, -- Each time Blizzard deals damage, the cooldown of Frozen Orb is reduced by ${$s1/100}.1 sec.
    ...
    snowstorm                = { 62170, 381706, 2 }, -- Blizzard has an $h% chance to increase the damage of your next Cone of Cold by $s2%, stacking up to $381522u times.
    splintering_cold         = { 62162, 379049, 2 }, -- Frostbolt and Flurry have a $s2% chance to generate $s1 Icicles.
    splintering_ray          = { 62152, 418733, 1 }, -- Ray of Frost deals $s1% of its damage to ${$384685i} nearby enemies.
    splitting_ice            = { 62161, 56377 , 1 }, -- Your Ice Lance and Icicles now deal $s3% increased damage, and hit a second nearby target for $s2% of their damage.; Your Ebonbolt and Glacial Spike also hit a second nearby target for $s4% of its damage.
