...
spec:RegisterTalents( {
    ...
    crushing_force                  = { 90369, 390642, 2 }, -- Shield Slam deals an additional $s1% damage and deals $s2% increased critical strike damage.;
    ...
    elysian_might                   = { 90323, 386285, 1 }, -- [386284] Spear of Bastion's duration is increased by ${$s1/1000} sec. While you remain within Spear of Bastion's area your critical strike damage is increased by $386286s1%.
    endurance_training              = { 90376, 391997, 1 }, -- Increases Stamina by $s1% and reduces the duration of movement impairing effects on you by ${$s4/10}.1%.
    ...
    piercing_verdict                = { 90379, 382948, 1 }, -- Spear of Bastion's instant damage increased by $s1% and its Rage generation is increased by $s2%.
    ...
    spear_of_bastion                = { 90380, 376079, 1 }, -- Throw a spear at the target location, dealing $376080s1 Physical damage instantly and an additional $376080o4 damage over $376081d. Deals reduced damage beyond $<cap> targets.; Enemies hit are chained to the spear's location for the duration.; Generates $/10;376080s3 Rage.
    ...
    champions_bulwark               = { 90316, 386328, 1 }, -- Shield Charge deals $s3% increased damage, grants you Shield Block, Revenge!, and generates an additional ${$s2/10} Rage.
