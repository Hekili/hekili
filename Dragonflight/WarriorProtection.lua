...
spec:RegisterTalents( {
    ...
    champions_spear                 = { 90380, 376079, 1 }, -- Throw a spear at the target location, dealing 2,915 Physical damage instantly and an additional 2,978 damage over 4 sec. Deals reduced damage beyond 5 targets. Enemies hit are chained to the spear's location for the duration. Generates 20 Rage.
