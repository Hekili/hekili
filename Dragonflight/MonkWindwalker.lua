...
spec:RegisterTalents( {
    ...
    -- Windwalker Talents
    ascension                   = { 80612, 115396, 1 }, -- Increases your maximum Chi by $s1, maximum Energy by $s3, and your Energy regeneration by $s2%.
    attenuation                 = { 80668, 386941, 1 }, -- Bonedust Brew's Shadow damage or healing is increased by $s1%, and when Bonedust Brew deals Shadow damage or healing, its cooldown is reduced by ${$s2/-1000}.1 sec.
    bonedust_brew               = { 80669, 386276, 1 }, -- [386949] Your abilities have a low chance to cast Bonedust Brew at your target's location.
    crane_vortex                = { 80667, 388848, 2 }, -- Spinning Crane Kick damage increased by $s1%.
    dance_of_chiji              = { 80626, 325201, 1 }, -- Spending Chi has a chance to make your next Spinning Crane Kick free and deal an additional $s1% damage.
    detox                       = { 80606, 218164, 1 }, -- Removes all Poison and Disease effects from the target.
    drinking_horn_cover         = { 80619, 391370, 1 }, -- The duration of $?s152173[Serenity][Storm, Earth, and Fire] is extended by $?s152173[${$s2/10}.1 sec every time you cast a Chi spender][${$s1/10}.1 sec for every Chi you spend].
    dust_in_the_wind            = { 80670, 394093, 1 }, -- Bonedust Brew's radius increased by $s1%.
    empowered_tiger_lightning   = { 80659, 323999, 1 }, -- Xuen strikes your enemies with Empowered Tiger Lightning every $s1 sec, dealing $s2% of the damage you and your summons have dealt to those targets in the last $s1 sec.
    faeline_harmony             = { 80671, 391412, 1 }, -- Your abilities reset Faeline Stomp $s2% more often. Enemies and allies hit by Faeline Stomp are affected by Fae Exposure, increasing your damage and healing against them by $395413s1% for $395413d.
    ...
    fatal_flying_guillotine     = { 80666, 394923, 1 }, -- Touch of Death strikes up to $s1 additional nearby $Ltarget;targets. This Touch of Death is always an Improved Touch of Death.
    fists_of_fury               = { 80613, 113656, 1 }, -- Pummels all targets in front of you, dealing ${5*$s5} Physical damage over $113656d to your primary target and ${5*$s5*$s6/100} damage over $113656d to all other enemies. Deals reduced damage beyond $s1 targets. Can be channeled while moving.
    flashing_fists              = { 80615, 388854, 2 }, -- Fists of Fury damage increased by $s1%.
    flying_serpent_kick         = { 80621, 101545, 1 }, -- Soar forward through the air at high speed for $d.;  ; If used again while active, you will land, dealing $123586s1 damage to all enemies within $123586A1 yards and reducing movement speed by $123586s2% for $123586d.
    forbidden_technique         = { 80608, 393098, 1 }, -- Touch of Death deals $s2% increased damage and can be used a second time within $213114d before its cooldown is triggered.
    fury_of_xuen                = { 80656, 396166, 1 }, -- Your Combo Strikes grant a stacking ${$396167s3/100}% chance for your next Fists of Fury to grant $s1% haste and invoke Xuen, The White Tiger for $396168d.
    glory_of_the_dawn           = { 80677, 392958, 1 }, -- Rising Sun Kick has a $s3% chance to trigger a second time, dealing $392959s1 Physical damage and restoring $s2 Chi.
    hardened_soles              = { 80611, 391383, 2 }, -- Blackout Kick critical strike chance increased by $s1% and critical damage increased by $s2%.
    hit_combo                   = { 80676, 196740, 1 }, -- Each successive attack that triggers Combo Strikes in a row grants $196741s1% increased damage, stacking up to $196741u times.
    inner_peace                 = { 80627, 397768, 1 }, -- Increases maximum Energy by $s1.; Tiger Palm damage increased by $s2%.
    ...
    invokers_delight            = { 80661, 388661, 1 }, -- You gain $388663m1% haste for $?a388212[${$s2-$s3} sec][$388663d] after summoning your Celestial.
    jade_ignition               = { 80607, 392979, 1 }, -- Whenever you deal damage to a target with Fists of Fury, you gain a stack of Chi Energy up to a maximum of $m2 stacks.; Using Spinning Crane Kick will cause the energy to detonate in a Chi Explosion, dealing $393056s1 Nature damage to all enemies within $393056A1 yards. The damage is increased by $393057m1% for each stack of Chi Energy.
    last_emperors_capacitor     = { 80664, 392989, 1 }, -- Chi spenders increase the damage of your next Crackling Jade Lightning by $393039s1% and reduce its cost by $393039s2%, stacking up to $393039u times.
    mark_of_the_crane           = { 80623, 220357, 1 }, -- Spinning Crane Kick's damage is increased by $220358s1% for each unique target you've struck in the last $220358d with Tiger Palm, Blackout Kick, or Rising Sun Kick. Stacks up to $228287i times.
    meridian_strikes            = { 80620, 391330, 1 }, -- When you Combo Strike, the cooldown of Touch of Death is reduced by ${$s2/100}.2 sec.; Touch of Death deals an additional $s1% damage.
    open_palm_strikes           = { 80678, 392970, 1 }, -- Fists of Fury damage increased by $s4%. When Fists of Fury deals damage, it has a $s2% chance to refund $s3 Chi.
    power_strikes               = { 80614, 121817, 1 }, -- Every $t1 sec, your next Tiger Palm will generate $129914s1 additional Chi and deal $121817s2% additional damage.
    rising_star                 = { 80673, 388849, 2 }, -- Rising Sun Kick damage increased by $s1% and critical strike damage increased by $s2%.
    rushing_jade_wind           = { 80625, 116847, 1 }, -- Summons a whirling tornado around you, causing ${(1+$d/$t1)*$148187s1} Physical damage over $d to all enemies within $107270A1 yards. Deals reduced damage beyond $s1 targets.
    serenity                    = { 80618, 152173, 1 }, -- Enter an elevated state of mental and physical serenity for $?s115069[$s1 sec][$d]. While in this state, you deal $s2% increased damage and healing, and all Chi consumers are free and cool down $s4% more quickly.
    shadowboxing_treads         = { 80624, 392982, 1 }, -- Blackout Kick damage increased by $s2% and strikes an additional $s1 $ltarget;targets.
    skyreach                    = { 80663, 392991, 1 }, -- Tiger Palm now has a ${$m1+5} yard range and dashes you to the target when used.; Tiger Palm also applies an effect which increases your critical strike chance by $344021m1% for $344021d on the target. This effect cannot be applied more than once every $337341d per target.
    skytouch                    = { 80663, 405044, 1 }, -- Tiger Palm now has a ${$m1+5} yard range.; Tiger Palm also applies an effect which increases your critical strike chance by $393047m1% for $393047d on the target. This effect cannot be applied more than once every $393050d per target.
    spiritual_focus             = { 80617, 280197, 1 }, -- Every $s1 Chi you spend reduces the cooldown of $?s152173[Serenity][Storm, Earth, and Fire] by $?s152173[${$m3/1000}.1][${$m2/1000}] sec.
    storm_earth_and_fire        = { 80618, 137639, 1 }, -- Split into 3 elemental spirits for $d, each spirit dealing ${100+$m1}% of normal damage and healing.; You directly control the Storm spirit, while Earth and Fire spirits mimic your attacks on nearby enemies.; While active, casting Storm, Earth, and Fire again will cause the spirits to fixate on your target.
    strike_of_the_windlord      = { 80675, 392983, 1 }, -- Strike with both fists at all enemies in front of you, dealing ${$395519s1+$395521s1} damage and reducing movement speed by $s2% for $d.
    teachings_of_the_monastery  = { 80616, 116645, 1 }, -- Tiger Palm causes your next Blackout Kick to strike an additional time, stacking up to $202090u.; Blackout Kick has a $s1% chance to reset the remaining cooldown on Rising Sun Kick.; $?a210802[Each additional Blackout Kick restores ${$210803m1/100}.2% mana.][]
    thunderfist                 = { 80674, 392985, 1 }, -- Strike of the Windlord grants you a stack of Thunderfist for each enemy struck. Thunderfist discharges upon melee strikes, dealing $242390s1 Nature damage.
    touch_of_karma              = { 80610, 122470, 1 }, -- Absorbs all damage taken for $d, up to $s3% of your maximum health, and redirects $s4% of that amount to the enemy target as Nature damage over $124280d.
    touch_of_the_tiger          = { 80622, 388856, 2 }, -- Tiger Palm damage increased by $s1%.
    transfer_the_power          = { 80660, 195300, 1 }, -- $?s116847[Rushing Jade Wind, ][]Blackout Kick and Rising Sun Kick increase damage dealt by your next Fists of Fury by $s1%, stacking up to $195321u times.
    way_of_the_fae              = { 80605, 392994, 1 }, -- Increases the initial damage of Faeline Stomp by ${$s1}% per target hit by that damage, up to a maximum of ${$s1*$s2}% additional damage.
    whirling_dragon_punch       = { 80658, 152175, 1 }, -- Performs a devastating whirling upward strike, dealing ${3*$158221s1} damage to all nearby enemies. Only usable while both Fists of Fury and Rising Sun Kick are on cooldown.
    widening_whirl              = { 80609, 388846, 1 }, -- Spinning Crane Kick radius increased by $s1%.
    xuens_battlegear            = { 80662, 392993, 1 }, -- Rising Sun Kick critical strikes reduce the cooldown of Fists of Fury by ${$m2/1000} sec.; When Fists of Fury ends, the critical strike chance of Rising Sun Kick is increased by $337482m1% for $337482d.
    xuens_bond                  = { 80665, 392986, 1 }, -- Abilities that activate Combo Strikes reduce the cooldown of Invoke Xuen, the White Tiger by ${$s2/-1000}.1 sec, and Xuen's damage is increased by ${$s1}%.
} )

-- PvP Talents
spec:RegisterPvpTalents( {
    alpha_tiger         = 3734, -- (287503) Attacking new challengers with Tiger Palm fills you with the spirit of Xuen, granting you $287504m1% haste for $287504d. ; This effect cannot occur more than once every $290512d per target.
    disabling_reach     = 3050, -- (201769) Disable now has a $s2 yard range.
    ...
    pressure_points     = 3744, -- (345829) Killing a player with Touch of Death $@switch<$s1>[reduces the remaining cooldown of][resets the cooldown of] Touch of Karma$@switch<$s1>[ by $s2 sec.][.]
    reverse_harm        = 852, -- (342928) Increases the healing done by Expel Harm by $m1%, and your Expel Harm now generates $m2 additional Chi.
