...
spec:RegisterSetting( "pyroblast_pull", false, {
    name = strformat( L["%s: Non-Instant Opener"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.pyroblast.id ) ),
    desc = strformat( L["If checked, a non-instant %s may be recommended as an opener against bosses."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.pyroblast.id ) ),
    type = "toggle",
    width = "full"
} )
...
spec:RegisterSetting( "prevent_hardcasts", false, {
    name = strformat( L["%s and %s: Instant-Only When Moving"],
