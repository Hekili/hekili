...
--[[ spec:RegisterSetting( "fire_at_will", false, {
    name = L["Accept Fire Disclaimer"],
    desc = L["The Fire Mage module is disabled by default, as it tends to require *much* more CPU usage than any other specialization module.  If you wish to use the Fire module, can check this box and reload your UI (|cFFFFD100/reload|r) and the module will be available again."],
    type = "toggle",
    width = "full"
} ) ]]

spec:RegisterSetting( "pyroblast_pull", false, {
    name = L["Allow |T135808:0|t Pyroblast Hardcast Pre-Pull"],
    desc = L["If checked, the addon will recommend an opener |T135808:0|t Pyroblast against bosses, if included in the current priority."],
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "prevent_hardcasts", false, {
    name = L["Prevent |T135808:0|t Pyroblast and |T135812:0|t Fireball Hardcasts While Moving"],
    desc = L["If checked, the addon will not recommend |T135808:0|t Pyroblast or |T135812:0|t Fireball if they have a cast time and you are moving.\n\nInstant |T135808:0|t Pyroblasts will not be affected."],
    type = "toggle",
    width = "full"
} )
