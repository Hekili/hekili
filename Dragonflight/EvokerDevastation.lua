...
spec:RegisterTalents( {
    ...
    -- Devastation Talents
    animosity              = { 93330, 375797, 1 }, -- Casting an empower spell extends the duration of Dragonrage by ${$s1/1000} sec.
    ...
    everburning_flame      = { 93365, 370819, 1 }, -- Red spells extend the duration of your Fire Breath's damage over time by $s1 sec.
    eye_of_infinity        = { 93318, 411165, 1 }, -- Eternity Surge deals $s1% increased damage to your primary target.
    feed_the_flames        = { 93313, 369846, 1 }, -- After casting $411288s2 Pyres, your next Pyre will explode into a Firestorm.
    firestorm              = { 93278, 368847, 1 }, -- An explosion bombards the target area with white-hot embers, dealing $<damage> Fire damage to enemies over $369372d.
    ...
    imminent_destruction   = { 93326, 370781, 1 }, -- Deep Breath reduces the Essence costs of Disintegrate and Pyre by $411055s1 for $411055d after you land.
    ...
    raging_inferno         = { 93277, 405659, 1 }, -- Firestorm's radius is increased by $s1%, and Pyre deals $s2% increased damage to enemies within your Firestorm.
    ...
    snapfire               = { 93277, 370783, 1 }, -- Living Flame has a $s1% chance to reset the cooldown of Firestorm, and make your next one instant cast and deal $370818s2% increased damage.
