...
spec:RegisterTalents( {
    ...
    astral_communion            = { 88235, 400636, 1 }, -- [202359] Generates ${$m1/10} Astral Power.
    astral_smolder              = { 88204, 394058, 2 }, -- Your critical strikes from Starfire and Wrath cause the target to languish for an additional $s1% of your spell's damage over $394061d.
    ...
    celestial_alignment         = { 88215, 395022, 1 }, -- [194223] Celestial bodies align, maintaining both Eclipses and granting $s1% haste for $d.
    convoke_the_spirits         = { 88206, 391528, 1 }, -- Call upon the Night Fae for an eruption of energy, channeling a rapid flurry of $s2 Druid spells and abilities over $d.$?s391538[ Chance to use an exceptional spell or ability is increased.][]; You will cast $?a24858|a197625[Starsurge, Starfall,]?a768[Ferocious Bite, Shred,]?a5487[Mangle, Ironfur,][Wild Growth, Swiftmend,] Moonfire, Wrath, Regrowth, Rejuvenation, Rake, and Thrash on appropriate nearby targets, favoring your current shapeshift form.
    cosmic_rapidity             = { 88227, 400059, 2 }, -- Your Moonfire, Sunfire, and Stellar Flare deal damage $s1% faster.
    denizen_of_the_dream        = { 88218, 394065, 1 }, -- Your Moonfire and Sunfire have a chance to summon a Faerie Dragon to assist you in battle for $394076d.
    ...
    elunes_guidance             = { 88228, 393991, 1 }, -- Incarnation: Chosen of Elune reduces the Astral Power cost of Starsurge by ${$s5*-1/10}, and the Astral Power cost of Starfall by ${$s6*-1/10}.; Convoke the Spirits' cooldown is reduced by ${($abs($s4)/120000)*100}% and its duration and number of spells cast is reduced by $s1%. Convoke the Spirits has an increased chance to use an exceptional spell or ability.
    ...
    friend_of_the_fae           = { 88234, 394081, 1 }, -- When a Faerie Dragon is summoned, your Arcane and Nature damage is increased by $394083m1% for $394083d.
    fungal_growth               = { 88205, 392999, 1 }, -- Enemies struck by Wild Mushrooms are damaged for an additional $s1% over $81281d and slowed by ${$81281s2*-1}%.
    fury_of_elune               = { 88224, 202770, 1 }, -- Calls down a beam of pure celestial energy that follows the enemy, dealing up to $<dmg> Astral damage over $d within its area. Damage reduced on secondary targets.; Generates ${$m3/10/$t3*$d} Astral Power over its duration.
    incarnation                 = { 88206, 394013, 1 }, -- [102560] An improved Moonkin Form that grants both Eclipses, any learned Celestial Alignment bonuses, and $s2% critical strike chance.; Lasts $d. You may shapeshift in and out of this improved Moonkin Form for its duration.
    incarnation_chosen_of_elune = { 88206, 394013, 1 }, -- [102560] An improved Moonkin Form that grants both Eclipses, any learned Celestial Alignment bonuses, and $s2% critical strike chance.; Lasts $d. You may shapeshift in and out of this improved Moonkin Form for its duration.
    ...
    moonkin_form                = { 82212, 24858 , 1 }, -- Shapeshift into $?s114301[Astral Form][Moonkin Form], increasing the damage of your spells by $s9% and your armor by $m3%, and granting protection from Polymorph effects.$?a231042[; While in this form, single-target attacks against you have a $h% chance to make your next Starfire instant.][]; The act of shapeshifting frees you from movement impairing effects.
    natures_balance             = { 88226, 202430, 1 }, -- While in combat you generate $m3 Astral Power every $m4 sec.; While out of combat your Astral Power rebalances to 50 instead of depleting to empty.
    natures_grace               = { 88222, 393958, 1 }, -- After an Eclipse ends, you gain $393959s1% Haste for $393959d.
    ...
    power_of_goldrinn           = { 88207, 394046, 2 }, -- Starsurge has a chance to summon the Spirit of Goldrinn, which immediately deals ${$394047s1*(1+$s2/100)} Astral damage to the target.
    primordial_arcanic_pulsar   = { 88221, 393960, 1 }, -- Every $s1 Astral Power spent grants Celestial Alignment for $s2 sec.
    ...
    rattle_the_stars            = { 88236, 393954, 1 }, -- Starsurge and Starfall reduce the cost of Starsurge and Starfall by $393955s1% and increase their damage by $393955s2% for $393955d, stacking up to $393955u times.
    ...
    starfire                    = { 82201, 194153, 1 }, -- Call down a burst of energy, causing $s1 Arcane damage to the target, and ${$m1*$m3/100} Arcane damage to all other enemies within $A1 yards. Deals reduced damage beyond $s5 targets.; Generates ${$m2/10} Astral Power.
    starlord                    = { 88200, 202345, 2 }, -- Starsurge and Starfall grant you $s1% Haste for $279709d.; Stacks up to $279709u times. Gaining a stack does not refresh the duration.
    ...
    stellar_flare               = { 91048, 202347, 1 }, -- Burns the target for $s1 Astral damage, and then an additional $o2 damage over $d. If dispelled, causes $356474s1 damage to the dispeller and blast them upwards.; Generates ${$m3/10} Astral Power.
    stellar_innervation         = { 88229, 394115, 1 }, -- During Solar Eclipse, Sunfire generates $s1% additional Astral Power. During Lunar Eclipse, Moonfire generates $s1% additional Astral Power.
    sundered_firmament          = { 88217, 394094, 1 }, -- Every other Eclipse creates a Fury of Elune at $s1% effectiveness that follows your current target for $s2 sec.
    ...
    umbral_embrace              = { 88216, 393760, 2 }, -- Dealing Astral damage has a chance to cause your next Wrath or Starfire cast during an Eclipse to become Astral and deal $s1% additional damage.
    umbral_intensity            = { 88219, 383195, 2 }, -- Solar Eclipse increases the damage of Wrath by an additional $s1%. ; Lunar Eclipse increases the damage Starfire deals to nearby enemies by an additional $s2%.
    waning_twilight             = { 88202, 393956, 2 }, -- When you have $s3 periodic effects from your spells on a target, your damage and healing on them are increased by $s1%.
    warrior_of_elune            = { 88210, 202425, 1 }, -- Your next $n Starfires are instant cast and generate $s2% increased Astral Power.
    wild_mushroom               = { 88220, 88747 , 1 }, -- Grow a magical mushroom at the target enemy's location. After $d, the mushroom detonates, dealing $88751s1 Nature damage and generating up to $88751s2 Astral Power based on targets hit.
