...
spec:RegisterSetting( "pad_windstrike", true, {
    name = strformat( L["Pad %s Cooldown"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.windstrike.id ) ),
...
spec:RegisterSetting( "pad_lava_lash", true, {
    name = strformat( L["Pad %s Cooldown"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.lava_lash.id ) ),
    desc = strformat( L["If checked, the cooldown of %1$s will be shortened to help ensure that it is recommended as frequently as possible during %2$s."],
...
spec:RegisterSetting( "hostile_dispel", false, {
    ...
    desc = strformat( L["If checked, %s or %s can be recommended your target has a dispellable magic effect."],
        Hekili:GetSpellLinkWithTexture( 370 ), Hekili:GetSpellLinkWithTexture( 378773 ) ) .. "\n\n"
        .. L["These abilities are also on the Interrupts toggle by default."],
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "purge_icd", 12, {
    name = strformat( L["%s Internal Cooldown"],
    ...
    desc = strformat( L["If set above zero, %s cannot be recommended again until time has passed since it was last used, even if there are more dispellable magic effects on your target."],
        Hekili:GetSpellLinkWithTexture( 370 ) ) .. "\n\n"
        .. L["This feature can prevent you from being encouraged to spam your dispel endlessly against enemies with rapidly stacking magic buffs."],
    type = "range",
    min = 0,
    max = 20,
    step = 1,
...
spec:RegisterSetting( "project_windfury", 0, {
    name = strformat( L["Use %1$s for %2$s"],
    ...
    desc = strformat( L["If set above zero, %1$s can be recommended to relocate your %2$s when it is active, will remain active for the specified time, and you are currently out of range."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.totemic_projection.id ), Hekili:GetSpellLinkWithTexture( spec.abilities.windfury_totem.id ) ) .. "\n\n"
        .. L["This feature may be disruptive if you have other totems active that you do not want to move."],
    type = "range",
    min = 0,
    max = 120,
    step = 1,
...
spec:RegisterSetting( "tp_macro", nil, {
    name = strformat( L["%s Macro"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.totemic_projection.id ) ),
    desc = strformat( L["This macro will use %1$s at your feet.  It can be useful for pulling your %2$s to you if you get out of range."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.totemic_projection.id ), Hekili:GetSpellLinkWithTexture( spec.abilities.windfury_totem.id ) ) .. "\n\n"
        .. strformat( L["You can also add this command to a macro for other abilities (like %s) to routinely bring your totems to your character."],
...
spec:RegisterSetting( "burn_before_wave", true, {
    name = strformat( L["Burn Maelstrom before %s"],
    ...
    desc = strformat( L["If checked, spending %1$s stacks may be recommended before using %2$s when %3$s is talented."],
        ...
        .. L["This feature is damage-neutral in single-target and a slight increase in multi-target scenarios."],
    type = "toggle",
    width = "full",
} )

spec:RegisterSetting( "pwave_targets", 0, {
    name = strformat( L["Required Targets for %s"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.primordial_wave.id ) ),
...
spec:RegisterSetting( "filler_shock", true, {
    ...
    desc = strformat( L["If checked, a filler %s may be recommended when nothing else is currently ready, even if something better will be off cooldown very soon."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.flame_shock.id ) ) .. "\n\n"
        .. L["This feature matches simulation profile behavior and is a small DPS increase, but has been confusing to some users."],
    type = "toggle",
    width = 1.5
} )


spec:RegisterPack( "Enhancement", 20230520, [[Hekili:L3ZAVjoYw(BbDvtdZKMaMqMPhb5Q7D2zKMrZo7vk3v73WymMG32yZ6hjDUcXV99uv5h1JtvLjaj9MvQFKqv(uN3VQYfZhn)Fo)(vE5bZ)tNHoJhoXz4GrJNCZKBNFF(Z7cMF)op)V49a8dXEBH)9xI34f7hSnioNm2ZrjERiWilPi1hgFtE(USF66RFimFtXYb(jBVolCBrKxEysSFQ36CYV7F9YOKLxVk17HK41rHpSj)6G4hcJdU2pYllZDBYQIOGSRZ8DZ24T1lEG)UDZVFzryu(VfpFjgsp(Mpd4XUaF4JVDmGkHRwfWMBqM)87jZ9tdN8jNH)0Hf)N7iai7WI8e4VPHXFjipBWHF)WVxnTr3at7xd)6Hf7sd26LxKgCyXFqq14W4hoS4VNeLFyXtaDEyX)4)Y7ry0W4dl(B)h)IiyCaW83wT6WcVODB8CFkjAT72WyxcqdJbmWlgg8xJa27Hf3VjX)laGw3atygjaC)5)nbWo8waS)7jP0v1pLkq8IaaeU9NpSOGrDIpHZX9e38PXdRFc9tY5Zm6lKiGndpNBRz8hwSonzlDYL6g)mr3a(4K0dlgbYtUNKG(WtEyXVb8by(5HFk3l9Hay6z(bXEPHjzxbpAyuuqQmRmBtsr0kcpm65dlwcduKfSIXILy6aNonyDAaOXTmkyW87JcZYZiA3EjbW)9NuRfybHrxn)Vp)E)0W8G0qpWwXlcyNdaf8SnG2HBwEs62SbLZ9WIUhw0J(NYjweNwe9S7tHXReNLNFE4JbUbXbBdjQN3nJWooSO)Hf73Rz4jWWao6tyJeKcWb3Okf155G5Gw8UxnixLKpynHFagCu2bb0YlhhkGo)BPikqgllwVEWU0WTjPRc9ICFc0LhuSRzSTEbrz5GoG7tbE7sIhKL7rGYmDJV17RULZHXm7uoZSDrHXa5eSYniIQvNrxjcUUMWfAS0Ms4woSHs9cHh4rIWWBfieeM0d(RilOaFTMJ6UeS8jS1X2uh2ctmi2fCO5bATYAdLtsMlvplcwwoN1HPbUXjp61mkJpljfgKh6)fQ3j2sOtwnvv02Nx9d7bULJv49ONl4NEdHlCJwUqhT6bnGsAm4XF2pkWLzFNrm5GLyIj93ZbBuhzdQcdBWvUHyXusd3XgH4y6byqWl0ZjfGtkIUYHfXjW)SH6g)FuJEhwWCSNg4T6zMV9DfrreEvE5J)KxCUS3PKIkVJ)XFalZV(Nxvg5OmoXtBcaifctcI5seOGmkmI5idyH3AIf2PMdvAbbmXSDHWuYe5J9AZezQE(BiIWmkpKy7w)7e4qvlwhKw)4ul2(v)5S6KWMRzm3QeFaJfS(BO3LGIp18)hSz(NVjbK6zUHXpM4tdYjWKYdjmfitGOMKkSr53boWAqkA4di5LVeqWNFul(CImtUylI4lzv)S5vDvcbG0WCvoLRClifOQE8gLSMmMeyCckomrhZkwtcweRyBHihn8OPJSGCiuqCrg41niD8qxND(nRrwr8k45lHU(mhSeoTKHyAw3y0fgzgmFQnU65CPv5rKIL6ZtOuGaI)iQ9tL8ObsH(WswRloYASXOsZrkYMPcVMymOHegPpSJoCTX6Qzi(qrqgPz5LU3jRG(Oo2dV)nqC5rux(QQJCKezww9IzGkjExzegEqsc817vIlxBPuIqItZffxBK((xy2Rq8FuLs9odnzEowJ9OJfFsyoqf4JRcc2bvzKMKKZNDSatLbPK4hdsFGl8ytWHBfCyWgU2o35KkjIT2rUAiezzf1zN5cDC4155cpkQ07mwW0GJKKM3n8ZJZdN00MWpnohxIZsWEug5LMRERstkso6uK0BeEHY(lpeWS8exHm)MYvy1zilqcfp51irphl54yebnM80ylw4en41fPpdSY8GTC1Ocy9qrf9MPrbSE7Yw40ES(ebA4ZgYfqmsAoyIbRwKLwO0XCutJPnuPfixupPHCqkZ3OPMFYWtL9WjxrQX(N0WmTJK6z3NG6f)YA2QenRzjxQik)6ZZcl)x6kHkfil0qnPhRptRwYaQch6)LicFpFdf6qs7pf3mUhPzHRiDVUkaJMkW6P(a1wE3XkUnjjIa8bS4bnd)989oYs7J0xsE7QF0kVz0liDGMztTTPQbQRkBmI4d4YLoT1fHalXr(LyDurA6ZczXrt2l0vKLjWnfR8vF0sD1U9AYrotmfBs8PwRJ3uICwAEWMKC3nEXRekysOCd9XiRQ3xkygpKudGzREC7(e00akJo7muNElxv600047EAgMpS(ObaC(oPeL0ewZmW626UKVmjJnFnTl3MJmd9n4y4AQ(V5vrqYEYqtgoT194JByK9OpeAlrZE6YvUSDA2J)BobxdT6Ob6NA0OjsoowwKwU6g7nDVZqVGvIobFoK2MRNVFr1(pEKeJCrkYMHeviJkfhtml0Aqn3CfSaFVKuZm0sdDXwFt6FRHEL8clkWCfbNu9vowB06r0ArU2OPj0Sy7o03gdl(PAvxtFj9crFFA(b(PzOpngAY4XQWZk2VAOLEp4MS2fwu)VKjTQgkEVYnZtHP0al1UseKKmvF1w5yZbK9m94ep89bYqxb0vuVDSXsUp2CeowOLD8AtsCBbLyZTpBSEnzCEUo(LGYCGxA(g36WNYRP(OyqHY5asMnGDcvuwsPUbyjYWLsoyjwYlTvu5KTkFnXl2CK2)iSl60eutl2bL6LSgsGhYojBGiOb2eigO2P2z3BaDPWiqyhMTliIZFEbuiaLMF5W4H0apyUU1WsVkhs7eQZ8wBwD6cUAkx9XdLZiKBj5TNBMGWAJpfoKOEc8TllH()5LDXPilaCyU2fQFHiT55isjGgwS1DhOZhK76f)yyu1jmu3W5QDmPcIErpeKdL3bsJ)1)cewlt(QkMiiq6On3(o6KkCJjjxusVudBNVXry9wcmLCOf)XORbCb8gaurvkNcQb9u0e(au02poSrJOFfJfJlLBQ5ja5(Oh8tWidkpIKJCdZa)oHPLTSG9PdYhbroYCjSCcdsOOLZRApk9YHg1m4vfP086zmcUzWwI6rBeE10kj5tMKeQw2FvZsD3mBRvd0EfmcfSdReqGVROKCUFp3uZDqeXoAeXoFBiIDSkIDoBIy016nxe7ijIDiIy5Y0QtGnWZpjMSvC5BajxWZjXREd8nAXF1Ks)vt4CxHI55iDgSIu36fd10)qAyWAWXP)MV9itheYubRZn2gs7(K7O1TC7CwyOBE29w0rRdJ2PgBOLEVIoBkJ)UmkjzLljB2A)am5N64VCNnMwR3oxnnOdvQ8ANCRrPsqAwqkP)kAKknJF6sfS16nuQuJouPIXJf9RSuHu3mvPbxO0m8jltWwP3orsn2qLig7K9RSeHSgqXdau99IIWflsZ5KLnAxZ3obKikrLscDvKFrKAPJH2RB58DskfuD)R7QE(JQ3LED9P8ZdfQVe)alid17OqvIpuZTPKM(26BctiOb2I1SmnceAtAKZvtSFpRRETSsIdoSGaXNVI862fMayZZKx3HOOKNG1aYa8WIpYofrFSsB7WcY7NfxdIicyx2V4sgI0Y40q)CPC)WKbS31lxwkzLNwPCK28lG)euG(6OTlQe9b4Dvj2QLk8so)KWDYKa5fwJ27TDPb(jBx6109TQLQUtDS2ikP7l2vwIMEEs8dfb4Z2YgX2yiKTjmiAvZgSw5wK1BvHrj6ALw5nBzzs6sEFbOBlndkM7jhoAvMJVomQRneAUuVIBWe9HQ3LM8Fh4N7k140MSLj)kuHq58cz9AZWzhkK8sdX2YS6yisnVvSxWQh(c5wcLSJ2r0MhPkOa5NIkcQZHNuXry2aKonvkpfMMCPpyZrt3aXMkEPUaQwAtOuUewRrocs1PDKQtlivN2tQohbP6iqQYU8TtQ9e7zPq846W)xtN0i6zFR60RuAM8uyU)g3vj(anN5wgj(5bPEXSnLVp7HgoCi9PSf5hM(0)QikXf)N)m4HasnzkidqS(YIdqS0x6Zle0KWe1VmW1FesMNW2lFh2HASU)jVuI7OS53)pjHkc3UljT6T(7JL7IYhjV5G)pfqANW6LLqm29kYt26Lt(ai7G4hOV21)rijMk5nU(NPhUF6Wj7cyz4LXEz1)yVoQzL2TdwgPLFQq2O93VVNwUr3EgyQtD(UYugLAYDFaMK0B72tiX2p8Hr)4WPZgpSpq)Kxz))VdMxJ41cLFquO8XkBBXU1urOAAMdmCVrFTFlaQspmrGm2CUOGVfaMj10du5XVO47fg86aSIbBh9D)RRgnLU9uTuavvelLYpvWsrJ5OjQz6mDsjIzNTckVBMjytGqh9wUDmeaPEq1qb9RDR8nc)9Dh7Twb)h1y54y25NYWcMJ6bQDZr85CrbFlaSzNFQJFrX3lm41by7o)CqmoDU4gNFWe1WzD6CswNiW(IzDQZ53Bd)9Dh7Twb)Zx60XXtDEcKb6KZxMZOz5wUg1K6OHVn0QZRaT6itRJUez0tV5Wo7Hkhn2MC58Bq)HYkMq2KZPZuh74SO1d7lM9CLY15Nt9oJr1O1DZBOwN6M42Wmv3S4JJzQc7lgZ8YR19oHr1O1n5TtRtDBQR5LQBg(rXkvH8fJtEXv5ExWLA03S2U1ZpJSItsahYwVxZoLg)fXt1Sgxmg7fx979itd0gP7EaBBNPhrapaVbvWNcixLRLx)PG6iD)OzyjBJOj7wyE18OxEHRtkIfM9QvKjVYl3BPxwWpD43pS4tWVxYyi3zRiBDr9Mq)XJAZl03Kv8nEdj)ATtSLDZfzR7WxfKz1(LqZo)HVs6NC7xqS9peF10mZw2pOwkNmmX2VqwLt6Mv7xI2kNSm52VGTsozAMclL1Up0SVxyB17h6n67hnyY3v68XWM72V)3t2W0VZKtS(t)RnlN624kcaehD8pU6U0j(4Q(xBITyMMV(DfnpG4F(3OUMjka3i69N44D(9G)4njPZVNCnEtpDkRdBEXIZgu7k)7NDnb54obrh(DSjPE2HWNN8HX5QW1ZOrZrp8qLTDu5q6SFFj5R5e60hFX5HJ(fUyxx8vTR5ffFnvpypKvg)4aHdbX5qEAYH)z2WY0GehMIO4WPkvMRiNBHQoK2SVxxrpniZSf9fy9McBknSgVJsZcZR2rqdo6ObDbCAwE0GfsdBLg06zUn0GM8klPK))KVAIxR)cjgfYRhCnNS0EG9ccZ)P03qxIXHM3Px(5k8w92YNH9cWsM85OofHYuiNBK97VavjWJ)Kgfhs8Fq160OtFf3Rs1Sr6FCeBkXhLYNo1MY)AD0DQp7oOem5TxQ2BjHUAZzh4YF0b(qZszy3ZoPtoWR4bhWkN3bLZJSXLx(9T8dnlLbo)jTTLVI7APEJCSiAxaRCt7LPEKtoM9RgI5OhXokpfDWDvyfWwne6GBjWd4M9g6Cfp799obkW7Q3HJlnV79X20WZ7QBw)fM19Ey7g45BI9w(cZ8Eh2SCOUI)svtqi8tYDB4xcCd(kueqmakclIfwzxYtqDbHXRlihAFkNwp(uoI(BmXUQsjEs0WdAIsXeZTeSgR(B)EPQsCgky8Y9mckN1KhHDP5nMSBVEkVPKDjWO51BB2OUQVtI3n7ZdPvcO8grk903ns0KPrnGGv4aE)EzyWka9S8(kYJmYVUFmDn2ZDf7n)JLZImhHIpNT3)q7Oe8qgWhc)PPLgm0NuzS4vqgn)eDQbL6F43C6D7HiNUXz)E1pE6T9rWeUvKIfTAvrGJ0DNADRcXVt2UB2e1odYStAinblogB9Uz3GS213sHL9Lq5Uxh1k5MHiGs0CRfubDy87jxexzDrmkvIlv55VPG9Y6XR6keTUCeKNA7sNkTJNwDTzK0g1TYnU5Rc8MEoOEjGZwbPlaCUUuO9w)UlpifVXVHhxXTigZGRrg1IrPq6xo67KiqtYLP4JvF9wIXjQVQrR5dC3z5AuJeBEoRypPUMJ(ShVBGYlF8z8FFOCUSlvVTXlT20C1GpL0y4Y7xCmxO3z6H7ww9m(9joEtmh5GAil5IOTKl21e(zJxEk(4olkk9WZvVJT4iAnjOxZ2SGENMRYjTIj3RNbGOH4BSR5Dd5P7g62cA2VpUzH4(FvtcnxhY4oqTfjw9jAFCyPBXwDEWRR0q560gl7HU4xJ2ZgIPIGKI2rKQv7Z0YMd7ske)AVURHR8AJsum8R5cgUjqb3fBTje1yYiMdoBtlQ1Qmcxi1y0x19xmhxv)1qDvTssm4tj2CR8suIyk320wmTpkdBojTDtpBCsC(eMhFXljA7wiOxo0TIjEg5vQjdHLluva9Xd5l3dkne3vwPqwZ3hBDRtFe77cD5I4NnIuTVYhY1V9s8ajIeUS7oPAyRHUY8UvtaLQJdYllwNTePuYHs1fC9GKsLuyeT39ALGqZxSM1LqO81YzFfpZ1D1bNzovKN3xJ)h(ilmQrooLW3(MSws0rJqI2QKVT)c6wMALCrCcYhC(7SHYRisIQ9SMZjwjUYT3OhsLp4nKUFFJ1e2c7jZoCKDFmD2yfJMJT3cin6WKx5rkEnpQsGSXcAHpzS0l7uv5J03bRxIepziMLeO3Vh9RwqzJe7XNbF3arOBSB0yDC3mHVVSvWEXkg0LkJE)Xi(UYBxFiljCXuynNlfEUThDiIxl)81AgwCjAgBvR6qfiisbUYkQJjQ4tT2BRgVX9p78KwPOpwHtI0zqvB8w3(t2Ztp84kFnrp7wfBKJpDq2cG9DbTsUG3O3TTbUGEZyT2fwOQxKGY51l0lYxcZtR773liemT)uNHOShxupHop1iVpUYvm6mrR7crhTD05PLEFUn))9p]] )