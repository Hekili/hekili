...
spec:RegisterTalents( {
    ...
    heroic_leap                     = { 90346, 6544  , 1 }, -- Leap through the air toward a target location, slamming down with destructive force to deal 1,999 Physical damage to all enemies within 8 yards.
    impending_victory               = { 90326, 202168, 1 }, -- Instantly attack the target, causing 4,255 damage and healing you for 30% of your maximum health. Killing an enemy that yields experience or honor resets the cooldown of Impending Victory and makes it cost no Rage.
    ...
    shattering_throw                = { 90351, 64382 , 1 }, -- Hurl your weapon at the enemy, causing 8,262 Physical damage, ignoring armor, and removing any magical immunities. Deals up to 500% increased damage to absorb shields.
    shockwave                       = { 90375, 46968 , 1 }, -- Sends a wave of force in a frontal cone, causing 1,702 damage and stunning all enemies within 10 yards for 2 sec. Generates 10 Rage.
    sonic_boom                      = { 90321, 390725, 1 }, -- Shockwave deals 350% increased damage and will always critical strike.
    spear_of_bastion                = { 90380, 376079, 1 }, -- Throw a spear at the target location, dealing 14,042 Physical damage instantly and an additional 15,380 damage over 4 sec. Deals reduced damage beyond 5 targets. Enemies hit are chained to the spear's location for the duration. Generates 20 Rage.
    ...
    storm_bolt                      = { 90337, 107570, 1 }, -- Hurls your weapon at an enemy, causing 2,425 Physical damage and stunning for 4 sec.
    thunderous_roar                 = { 90359, 384318, 1 }, -- Roar explosively, dealing 13,616 Physical damage to enemies within 12 yds and cause them to bleed for 43,769 physical damage over 16 sec. Generates 10 Rage.
    ...
    titanic_throw                   = { 90341, 384090, 1 }, -- Throws your weapon at the enemy, causing 2,979 Physical damage to it and 5 nearby enemies. Generates high threat.
    ...
    wrecking_throw                  = { 90351, 384110, 1 }, -- Hurl your weapon at the enemy, causing 8,262 Physical damage, ignoring armor. Deals up to 500% increased damage to absorb shields.
    ...
    bladestorm                      = { 90441, 227847, 1 }, -- Become an unstoppable storm of destructive force, striking all nearby enemies for 30,529 Physical damage over 5.0 sec. Deals reduced damage beyond 8 targets. You are immune to movement impairing and loss of control effects, but can use defensive abilities and can avoid attacks. Generates 20 Rage.
    ...
    cleave                          = { 90293, 845   , 1 }, -- Strikes all enemies in front of you for 6,553 Physical damage, inflicting Deep Wounds. Cleave will consume your Overpower effect to deal increased damage. Deals reduced damage beyond 5 targets.
    ...
    colossus_smash                  = { 90290, 167105, 1 }, -- Smashes the enemy's armor, dealing 20,080 Physical damage, and increasing damage you deal to them by 30% for 13 sec.
    ...
    dreadnaught                     = { 90285, 262150, 1 }, -- Overpower has 2 charges and causes a seismic wave, dealing 3,561 damage to all enemies in a 10 yd line. Deals reduced damage beyond 5 targets.
    ...
    fatality                        = { 90439, 383703, 1 }, -- Your Mortal Strikes and Cleaves against enemies above 30% health have a high chance to apply Fatal Mark. When an enemy falls below 30% health, Your next Execute inflicts an additional 19,829 Physical damage per stack.
    ...
    ignore_pain                     = { 90269, 190456, 1 }, -- Fight through the pain, ignoring 50% of damage taken, up to 28,918 total damage prevented.
    ...
    mortal_strike                   = { 90270, 12294 , 1 }, -- A vicious strike that deals 18,086 Physical damage and reduces the effectiveness of healing on the target by 50% for 10 sec.
    overpower                       = { 90271, 7384  , 1 }, -- Overpower the enemy, dealing 10,340 Physical damage. Cannot be blocked, dodged, or parried. Increases the damage of your next Mortal Strike or Cleave by 30%. Stacking up to 2 times
    reaping_swings                  = { 90294, 383293, 1 }, -- Cooldown of Cleave reduced by 3 sec.
    rend                            = { 90284, 772   , 1 }, -- Wounds the target, causing 5,464 Physical damage instantly and an additional 20,593 Bleed damage over 21 sec.
    ...
    sidearm                         = { 90333, 384404, 1 }, -- Your auto-attacks have a 20% chance to hurl weapons at your target and 3 other enemies in front of you, dealing an additional 2,127 Physical damage.
    skullsplitter                   = { 90281, 260643, 1 }, -- Bash an enemy's skull, dealing 10,212 Physical damage. Skullsplitter causes your Deep Wounds to expire instantly. Generates 15 Rage.
    ...
    thunder_clap                    = { 92224, 396719, 1 }, -- Blasts all enemies within 8 yards for 4,325 Physical damage. and reduces their movement speed by 20% for 10 sec. Deals reduced damage beyond 5 targets.
    ...
    warbreaker                      = { 90287, 262161, 1 }, -- Smash the ground and shatter the armor of all enemies within 8 yds, dealing 20,080 Physical damage and increasing damage you deal to them by 30% for 13 sec.
