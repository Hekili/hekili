...
spec:RegisterSetting( "purify_for_celestial", true, {
    name = strformat( L["%s: Maximize Shield"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.celestial_brew.id ) ),
    desc = strformat( L["If checked, %1$s may be recommended more frequently to build stacks of %2$s for your %3$s shield."],
        ...
        Hekili:GetSpellLinkWithTexture( spec.abilities.celestial_brew.id ) ) .. "\n\n"
        .. strformat( L["This feature may work best with the %1$s talent, but risks leaving you without a charge of %2$s following a large spike in your %3$s."],
        Hekili:GetSpellLinkWithTexture( spec.talents.light_brewing[2] ), spec.abilities.purifying_brew.name,
        Hekili:GetSpellLinkWithTexture( 115069 ) ),
    type = "toggle",
    width = "full",
} )
...
spec:RegisterSetting( "purify_for_niuzao", true, {
    name = strformat( L["%s: Maximize %s"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Hekili:GetSpellLinkWithTexture( spec.talents.improved_invoke_niuzao[2] ) ),
    desc = strformat( L["If checked, %1$s may be recommended when %2$s is active if %3$s is talented."],
        ...
        .. strformat( L["This feature is used to maximize %s damage from your guardian."],
...
spec:RegisterSetting( "purify_stagger_currhp", 12, {
    name = strformat( L["%s: %s Tick %% Current Health"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Hekili:GetSpellLinkWithTexture( 115069 ) ),
    desc = strformat( L["If set above zero, %1$s may be recommended when your current %2$s ticks for this percentage of your |cFFFFD100current|r effective health (or more)."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Hekili:GetSpellLinkWithTexture( 115069 ) ) .. "  "
...
spec:RegisterSetting( "purify_stagger_maxhp", 6, {
    name = strformat( L["%s: %s Tick %% Maximum Health"],
        Hekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Hekili:GetSpellLinkWithTexture( 115069 ) ),
    desc = strformat( L["If set above zero, %1$s may be recommended when your current %2$s ticks for this percentage of your |cFFFFD100maximum|r health (or more)."],
        Hekili:GetSpellLinkWithTexture( spec.abilities.purifying_brew.id ), Hekili:GetSpellLinkWithTexture( 115069 ) ) .. "  "
        .. L["Custom priorities may ignore this setting."] .. "\n\n"
        .. L["This value is halved when playing solo."],
    type = "range",
