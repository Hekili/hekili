...
spec:RegisterTalents( {
    aftershock                    = { 69777, 273221, 1 }, --
    ancestral_defense             = { 69728, 382947, 1 }, --
    ancestral_guidance            = { 69685, 108281, 1 },
    ancestral_wolf_affinity       = { 69839, 382197, 1 },
    ascendance                    = { 69785, 114050, 1 },
    astral_bulwark                = { 69723, 377933, 1 },
    astral_shift                  = { 69724, 108271, 1 },
    brimming_with_life            = { 69680, 381689, 1 },
    call_of_fire                  = { 69845, 378255, 1 },
    call_of_the_elements          = { 69687, 108285, 1 },
    call_of_thunder               = { 69836, 378241, 1 },
    capacitor_totem               = { 69722, 192058, 1 },
    chain_heal                    = { 69707, 1064  , 1 },
    chain_lightning               = { 69718, 188443, 1 },
    cleanse_spirit                = { 69720, 51886 , 1 },
    creation_core                 = { 69686, 383012, 1 },
    deeply_rooted_elements        = { 69785, 378270, 1 },
    earth_elemental               = { 69708, 198103, 1 },
    earth_shield                  = { 69709, 974   , 1 },
    earth_shock                   = { 69841, 8042  , 1 },
    earthgrab_totem               = { 69696, 51485 , 1 },
    earthquake                    = { 69834, 61882 , 1 },
    echo_chamber                  = { 69786, 382032, 2 },
    echo_of_the_elements          = { 69776, 333919, 1 },
    echoes_of_great_sundering     = { 69792, 384087, 2 },
    electrified_shocks            = { 69797, 382086, 1 },
    elemental_blast               = { 69791, 117014, 1 },
    elemental_equilibrium         = { 69790, 378271, 2 },
    elemental_fury                = { 69840, 60188 , 1 },
    elemental_orbit               = { 69703, 383010, 1 },
    elemental_warding             = { 69729, 381650, 2 },
    enfeeblement                  = { 69679, 378079, 1 },
    eye_of_the_storm              = { 69796, 381708, 2 },
    fire_and_ice                  = { 69727, 382886, 1 },
    fire_elemental                = { 69842, 198067, 1 },
    flames_of_the_cauldron        = { 69783, 378266, 1 },
    flash_of_lightning            = { 69793, 381936, 1 },
    flow_of_power                 = { 69838, 385923, 1 },
    flurry                        = { 69716, 382888, 1 },
    flux_melting                  = { 69797, 381776, 1 },
    focused_insight               = { 69715, 381666, 2 },
    frost_shock                   = { 69719, 196840, 1 },
    further_beyond                = { 69774, 381787, 1 },
    ...
    heat_wave                     = { 69787, 386474, 1 },
    hex                           = { 69711, 51514 , 1 },
    icefury                       = { 69837, 210714, 1 },
    improved_call_of_the_elements = { 69686, 383011, 1 },
    improved_flametongue_weapon   = { 69782, 382027, 1 },
    improved_lightning_bolt       = { 69698, 381674, 2 },
    inundate                      = { 69835, 378776, 1 },
    lava_burst                    = { 69726, 51505 , 1 },
    lava_surge                    = { 69844, 77756 , 1 },
    lightning_lasso               = { 69684, 305483, 1 },
    lightning_rod                 = { 69772, 210689, 1 },
    liquid_magma_totem            = { 69781, 192222, 1 },
    maelstrom_weapon              = { 69717, 187880, 1 },
    magma_chamber                 = { 69780, 381932, 2 },
    mana_spring_totem             = { 69702, 381930, 1 },
    master_of_the_elements        = { 69784, 16166 , 2 },
    mountains_will_fall           = { 69773, 381726, 1 },
    natures_fury                  = { 69714, 381655, 2 },
    natures_guardian              = { 69697, 30884 , 2 },
    natures_swiftness             = { 69699, 378081, 1 },
    oath_of_the_far_seer          = { 69775, 381785, 2 },
    planes_traveler               = { 69723, 381647, 1 },
    poison_cleansing_totem        = { 69681, 383013, 1 },
    power_of_the_maelstrom        = { 69798, 191861, 2 },
    primal_elementalist           = { 69781, 117013, 1 },
    primordial_bond               = { 69843, 381764, 1 },
    primordial_fury               = { 69839, 378193, 1 },
    primordial_wave               = { 69789, 375982, 1 },
    purge                         = { 69713, 370   , 1 },
    refreshing_waters             = { 69843, 378211, 1 },
    rolling_magma                 = { 69788, 386443, 2 },
    searing_flames                = { 69778, 381782, 2 },
    skybreakers_fiery_demise      = { 69779, 378310, 1 },
    spirit_walk                   = { 69690, 58875 , 1 },
    spirit_wolf                   = { 69721, 260878, 1 },
    spiritwalkers_aegis           = { 69705, 378077, 1 },
    spiritwalkers_grace           = { 69706, 79206 , 1 },
    splintered_elements           = { 69787, 382042, 1 },
    static_charge                 = { 69694, 265046, 1 },
    stoneskin_totem               = { 69682, 383017, 1 },
    storm_elemental               = { 69842, 192249, 1 },
    stormkeeper                   = { 69795, 191634, 1 },
    stormkeeper                   = { 69772, 191634, 1 },
    surge_of_power                = { 69777, 262303, 1 },
    surging_shields               = { 69691, 382033, 2 },
    swelling_maelstrom            = { 69799, 381707, 1 },
