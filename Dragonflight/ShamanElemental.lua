...
spec:RegisterTalents( {
    aftershock = { 69777, 273221 },
    ancestral_defense = { 69728, 382947 },
    ancestral_guidance = { 69685, 108281 },
    ancestral_wolf_affinity = { 69839, 382197 },
    ascendance = { 69785, 114050 },
    astral_bulwark = { 69723, 377933 },
    astral_shift = { 69724, 108271 },
    brimming_with_life = { 69680, 381689 },
    call_of_fire = { 69845, 378255 },
    call_of_the_elements = { 69687, 108285 },
    call_of_thunder = { 69836, 378241 },
    capacitor_totem = { 69722, 192058 },
    chain_heal = { 69707, 1064 },
    chain_lightning = { 69718, 188443 },
    cleanse_spirit = { 69720, 51886 },
    creation_core = { 69686, 383012 },
    deeply_rooted_elements = { 69785, 378270 },
    earth_elemental = { 69708, 198103 },
    earth_shield = { 69709, 974 },
    earth_shock = { 69841, 8042 },
    earthgrab_totem = { 69696, 51485 },
    earthquake = { 69834, 61882 },
    echo_chamber = { 69786, 382032 },
    echo_of_the_elements = { 69776, 333919 },
    echoes_of_great_sundering = { 69792, 384087 },
    electrified_shocks = { 69797, 382086 },
    elemental_blast = { 69791, 117014 },
    elemental_equilibrium = { 69790, 378271 },
    elemental_fury = { 69840, 60188 },
    elemental_orbit = { 69703, 383010 },
    elemental_warding = { 69729, 381650 },
    enfeeblement = { 69679, 378079 },
    eye_of_the_storm = { 69796, 381708 },
    fire_and_ice = { 69727, 382886 },
    fire_elemental = { 69842, 198067 },
    flames_of_the_cauldron = { 69783, 378266 },
    flash_of_lightning = { 69793, 381936 },
    flow_of_power = { 69838, 385923 },
    flurry = { 69716, 382888 },
    flux_melting = { 69797, 381776 },
    focused_insight = { 69715, 381666 },
    frost_shock = { 69719, 196840 },
    further_beyond = { 69774, 381787 },
    ...
    heat_wave = { 69787, 386474 },
    hex = { 69711, 51514 },
    icefury = { 69837, 210714 },
    improved_call_of_the_elements = { 69686, 383011 },
    improved_flametongue_weapon = { 69782, 382027 },
    improved_lightning_bolt = { 69698, 381674 },
    inundate = { 69835, 378776 },
    lava_burst = { 69726, 51505 },
    lava_surge = { 69844, 77756 },
    lightning_lasso = { 69684, 305483 },
    lightning_rod = { 69772, 210689 },
    liquid_magma_totem = { 69781, 192222 },
    maelstrom_weapon = { 69717, 187880 },
    magma_chamber = { 69780, 381932 },
    mana_spring_totem = { 69702, 381930 },
    master_of_the_elements = { 69784, 16166 },
    mountains_will_fall = { 69773, 381726 },
    natures_fury = { 69714, 381655 },
    natures_guardian = { 69697, 30884 },
    natures_swiftness = { 69699, 378081 },
    oath_of_the_far_seer = { 69775, 381785 },
    planes_traveler = { 69723, 381647 },
    poison_cleansing_totem = { 69681, 383013 },
    power_of_the_maelstrom = { 69798, 191861 },
    primal_elementalist = { 69781, 117013 },
    primordial_bond = { 69843, 381764 },
    primordial_fury = { 69839, 378193 },
    primordial_wave = { 69789, 375982 },
    purge = { 69713, 370 },
    refreshing_waters = { 69843, 378211 },
    rolling_magma = { 69788, 386443 },
    searing_flames = { 69778, 381782 },
    skybreakers_fiery_demise = { 69779, 378310 },
    spirit_walk = { 69690, 58875 },
    spirit_wolf = { 69721, 260878 },
    spiritwalkers_aegis = { 69705, 378077 },
    spiritwalkers_grace = { 69706, 79206 },
    splintered_elements = { 69787, 382042 },
    static_charge = { 69694, 265046 },
    stoneskin_totem = { 69682, 383017 },
    storm_elemental = { 69842, 192249 },
    stormkeeper = { 69795, 191634 },
    stormkeeper = { 69772, 191634 },
    surge_of_power = { 69777, 262303 },
    surging_shields = { 69691, 382033 },
    swelling_maelstrom = { 69799, 381707 },
    ...
    tumultuous_fissures = { 69835, 381743 },
    unrelenting_calamity = { 69794, 382685 },
    voodoo_mastery = { 69679, 204268 },
    wind_rush_totem = { 69696, 192077 },
    wind_shear = { 69725, 57994 },
    winds_of_alakir = { 69689, 382215 },
    windspeakers_lava_resurgence = { 69779, 378268 },
} )
