...
L["If checked, abilities from Minor CDs can be recommended."] = true
...
L["If checked, when Cooldowns are enabled, the addon will also recommend Minor CDs even if Show Minor CDs is not checked."] = true
L["If checked, when Cooldowns are enabled, the addon will also recommend Potions even if Show Potions is not checked."] = true
...
L["Set a key to toggle Minor CDs recommendations on/off."] = true
...
L["%s |TInterface\\Addons\\Hekili\\Textures\\Cancel:0|t Cancel"] = true
L["(Bear)"] = true
L["(Cat)"] = true
L["Canceling it allows you to start building stacks via %s and %s at its full duration."] = true
...
L["If checked, canceling |TInterface\\Addons\\Hekili\\Textures\\Cancel:0|t your %s may be recommended."] = true
...
L["You will likely want a |cFFFFD100/cancelaura %s|r macro to manage this during combat."] = true
