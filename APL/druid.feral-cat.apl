...
actions.cat+=/mangle_cat,if=!up&!debuff.mangle_bear.up
actions.cat+=/dire_bear_form,if=debuff.lacerate.up&debuff.lacerate.remains<3&!buff.berserk.up&debuff.rip.remains>4
actions.cat+=/wait,sec=debuff.rip.remains,if=debuff.rip.remains<energy.time_to_max&combo_points.current=5&!buff.berserk.up
actions.cat+=/wait,sec=energy.time_to_90,if=debuff.rip.up&buff.savage_roar.up&debuff.rip.remains-buff.savage_roar.remains>=-3&debuff.rip.remains-buff.savage_roar.remains<=0&debuff.rip.remains<4&combo_points=5&!buff.berserk.up
actions.cat+=/rip,if=(!up|debuff.rip.remains<4)&combo_points.current=5
actions.cat+=/savage_roar,if=(debuff.rip.up&buff.savage_roar.up&buff.savage_roar.remains-debuff.rip.remains<0&debuff.rip.remains+10<14+((combo_points.current-1)*5))|(debuff.rip.up&remains<4&((combo_points.current<4&debuff.rip.remains>9)|(combo_points.current=4&debuff.rip.remains>13)|(combo_points.current=5&debuff.rip.remains>16)))|(!debuff.rip.up&!up&combo_points.current<4)|(debuff.rip.up&buff.savage_roar.up&buff.savage_roar.remains-debuff.rip.remains<0&debuff.rip.remains+2<14+((combo_points.current-1)*5)&debuff.rip.remains<9)
...
actions.cat+=/dire_bear_form,if=!buff.berserk.up&cooldown.tigers_fury.remains>10&debuff.rip.remains>10&buff.savage_roar.remains>8&energy.current<50
