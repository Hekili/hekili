...
ns.Patrons = "|cFFFFD100Current Dragonflight Status|r\n\n"
    ...
    .. "|cFFFFAE42Beta|r\n"
    .. "- |c" .. RAID_CLASS_COLORS.DRUID.colorStr .. "Guardian Druid|r, |c" .. RAID_CLASS_COLORS.EVOKER.colorStr .. "Devastation Evoker|r, |c" .. RAID_CLASS_COLORS.MAGE.colorStr .. "Fire and Frost Mages|r, |c"
